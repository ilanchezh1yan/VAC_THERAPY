...
#define PAUSE                       0x0018       // SAME DATA FOR ALERT POPUP TOO          
#define RESUME                      0x0016
#define STOP                        0x0017
...
#define SET_INITIAL_VALUES          0X2500
...
#define SEAL_STATUS                 MODE_INTERRUPTION
...
#define ORGANIZE_COMMAND(x) (uint16_t)(x << 8 | x >> 8)
#endif